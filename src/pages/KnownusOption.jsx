...
const KnownusOption = () => {
  ...
  const handleSubmit = (e) => {
    ...
    navigate("/knownus"); // Navigate back after submission
  };


  return (
    <div className="flex p-10 justify-center items-center  mt-32 md:mt-24 lg:mt-24 md:ml-20  ml-0  min-h-screen h-screen ">
    <form
